...
/// FaceAnchor + ACC_N=6 + AWAKEN_PET_V2 match TerminalRenderer_GOOD.sol.
/// Visuals match the morning faces3 / traits archive (fill-forward pets,
/// fill-only shells, dark bezel, speaker dashes, split PET#{id} footer).
