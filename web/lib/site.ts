...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Ignite the Dial is a short CRT arena at /arcade. Hunt Dial ticks, dash through glitches to Ignite them, graze for CLOSE bonus, and chain combos. One best score per wallet. Top 150 wallets lock GTD (and FCFS via GTD) on the hub checker. Play before Friday, September 18, 2026 5:00 AM PT so winners can merge before the 7:00 AM PT hub redeploy. Hub preview only — not an on-chain mint allowlist.",
  },
  {
