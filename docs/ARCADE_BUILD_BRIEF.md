...
- Playable canvas at `/arcade`: **Ignite the Dial** — Doodle Jump climber with example BOLT (robot pet only, not handheld token art). Bounce up, steer, glitch pads are penalties, catch Dial ticks (45s).
